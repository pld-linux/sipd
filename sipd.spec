...
sipd jest serwerem SIP przekierowującym, buforującym i rejestrującym,
udostępniającym mapowanie nazw i usługi związane z lokalizowaniem
użytkownika i skryptami. Może używać zewnętrznych funkcji do
wykonywania właściwego rozwiązywania aliasów (włącznie z nazwami
grup), mapowania nazw i lokalizowania użytkowników. sipd pozwala
także użytkownikom na rejestrowanie na serwerze swojej aktualnej
lokalizacji. Użytkownicy mogą być zarejestrowani w wielu
lokalizacjach. Każdy użytkownik może zarejestrować skrypt w dowolnym
języku skryptowym lub formacie wykonywalnym rozumianym przez serwer;
skrypt ten będzie wykonywany po odebraniu połączenia. Interfejs
